...
// Function to multiply two binary matrices
    ...
    for (int i = 0; i < rows1; i++) {
        for (int j = 0; j < cols2; j++) {
            ...
            for (int k = 0; k < cols1; k++) {
                ...
                // Binary addition is equivalent to logical OR (but with carry)
                // Here we use XOR for sum and AND for carry (like binary addition)
